...
<body>
  <div class="row">
    <div class="label">Mã đơn hàng / Order No:</div>
    <div class="value">{{ORDER_NO}}</div>
  </div>
  <div class="row">
    <div class="label">Khách hàng / Customer:</div>
  ...
  <div class="row">
    <div class="label">Ngày tham quan / Visit Date:</div>
    <div class="value">{{VISIT_DATE}}</div>
  </div>
  <div class="row">
    <div class="label">Ngày mua / Purchase Date:</div>
  ...
  <div class="qr-section">
    <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ORDER_NO}}" alt="QR Code">
    <div class="qr-text">
...
function PageMenu() {
  ...
  const [hvOrderNo, setHvOrderNo] = reactExports.useState("");
  ...
  reactExports.useEffect(() => {
    fetchData();
    const intervalId = setInterval(fetchData, 5e3);
  ...
  const handleCheckHoangVanOrder = async (scannedValue) => {
  ...
  const executeUseHoangVanOrder = async () => {
    ...
    try {
      ...
      const finalHtml = receiptHtml.replace(/{{ORDER_NO}}/g, hvOrderInfo.orderNo || "").replace(/{{CUSTOMER_NAME}}/g, hvOrderInfo.buyerName || "").replace(/{{EMAIL}}/g, hvOrderInfo.buyerEmail || "").replace(/{{VISIT_DATE}}/g, hvOrderInfo.visitDate || "").replace(
        /{{PURCHASE_DATE}}/g,
          ...
          "div",
          {
            ...
            children: [
              isNew && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.actionBlock, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles$1.actionTitle, children: "Ready for Handover" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$1.actionDesc, children: "Hand the devices to the customer and confirm below." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
...
function PageExpiredOrders() {
  ...
  const fetchExpiredOrders = async (pageNum = 1, isLoadMore = false) => {
    try {
      setLoading(true);
      setError(null);
      const res = await SpeedPosService.getExpiredOrders(
        pageNum,
        50
      );
      if (res.success && res.data) {
