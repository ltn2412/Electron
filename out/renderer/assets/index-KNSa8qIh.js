...
const CircleMinus = createLucideIcon("circle-minus", __iconNode$e);
const __iconNode$d = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
  ["path", { d: "M8 12h8", key: "1wcyev" }],
  ["path", { d: "M12 8v8", key: "napkw2" }]
];
const CirclePlus = createLucideIcon("circle-plus", __iconNode$d);
const __iconNode$c = [
  ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
...
const Delete = createLucideIcon("delete", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
...
const KeypadControl = ({
  ...
  const [hoverKey, setHoverKey] = reactExports.useState(null);
  ...
  const getButtonStyle = (key) => {
    ...
    return {
      ...
      color: baseColor,
      cursor: "pointer",
      boxShadow: isActive ? "0 2px 4px rgba(0, 0, 0, 0.02)" : isHovered ? "0 6px 12px rgba(0, 0, 0, 0.05)" : "0 4px 6px rgba(0, 0, 0, 0.02), 0 1px 3px rgba(0,0,0,0.05)",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$6.grid, children: keys.map((key, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: key === "⌫" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Delete, { size: 28 }) : key
    },
    index
  )) });
};
...
const TitleBar = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$5.titleBar, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$5.dragRegion, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$5.title, children: "POS Audio" }) }),
...
function PageLogin() {
  ...
  const [configError, setConfigError] = reactExports.useState("");
  reactExports.useEffect(() => {
  ...
  const btnStyle = {
    ...
    maxWidth: "320px",
    height: "64px",
    background: isLoading || password.length === 0 ? "#cbd5e1" : "linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)",
    color: "white",
    fontSize: "20px",
    fontWeight: 600,
    borderRadius: "16px",
    ...
    boxShadow: isLoading || password.length === 0 ? "none" : isActive ? "0 2px 10px rgba(37, 99, 235, 0.3)" : isHovered ? "0 6px 20px rgba(37, 99, 235, 0.4)" : "0 4px 14px rgba(37, 99, 235, 0.3)",
    transform: isActive ? "translateY(1px)" : isHovered && !isLoading && password.length > 0 ? "translateY(-2px)" : "none",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$4.container, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$4.card, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles$4.title, children: "POS Audio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$4.subtitle, children: "Please enter your PIN to continue" }),
      configError ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            color: "red",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isLoading ? "Authenticating..." : "Login"
          }
        )
      ] })
    ] }) })
...
const HOANGVAN_CREDENTIALS = {
  ...
  // Replace with real password or fetch from config
};
  ...
  async (error) => {
    ...
    if (error.response?.status === 401 && originalRequest && !originalRequest._retry) {
      ...
      try {
        ...
        const errMessage = refreshError?.response?.data?.message || refreshError.message;
        showAlert(
...
class HoangVanService {
   ...
   */
  static async getOrderStatus(orderNo) {
   ...
   * 4.2 Use Order
   */
  static async useOrder(orderNo, payload) {
    const response = await api.post(
      `/orders/${orderNo}/use`,
      payload
    );
   ...
   */
  static async getExpiredOrders(page = 1, pageSize = 50) {
   ...
   */
  static async confirmExpiredOrders(payload) {
  ...
  static async getSlots(date) {
    ...
    const response = await api.get(`/slots?date=${targetDate}`);
    return response.data;
  }
}
function AlertModal({
  ...
  const getIcon = () => {
    switch (type) {
      ...
      case "confirm":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 48, color: "#f59e0b" });
      case "info":
      default:
...
function HoangVanSearchModal({
  ...
  const [localOrderNo, setLocalOrderNo] = reactExports.useState("");
  const [prevIsOpen, setPrevIsOpen] = reactExports.useState(isOpen);
  const isScanning = localOrderNo.startsWith("http") || localOrderNo.length > 25;
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", width: "100%" }, children: [
                  ...
                  isScanning && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { size: 20 }),
                        " Scanning barcode..."
                      ]
                    }
                  )
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    style: {
                      ...
                      cursor: localOrderNo && !hvChecking ? "pointer" : "not-allowed",
...
const receiptHtml = '<!doctype html>\n<html>\n  <head>\n    <meta charset="utf-8" />\n    <style>\n      @page {\n        margin: 0;\n      }\n      body {\n        font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;\n        margin: 0;\n        padding: 0;\n        color: #000;\n        width: 265px;\n        box-sizing: border-box;\n        font-weight: 900 !important;\n      }\n      .row {\n        display: flex;\n        justify-content: space-between;\n        margin-bottom: 6px;\n      }\n      .label {\n        color: #000;\n        font-size: 11px;\n        padding-right: 2px;\n        flex: 0 0 42%;\n      }\n      .value {\n        text-align: right;\n        font-size: 11px;\n        word-break: break-word;\n        flex: 0 0 58%;\n      }\n      .divider {\n        border-top: 1px dashed #000;\n        margin: 10px 0;\n      }\n      .qr-section {\n        text-align: center;\n        margin: 15px 0;\n      }\n      .qr-section img {\n        width: 150px;\n        height: 150px;\n        border: 2px solid #000;\n        padding: 5px;\n        border-radius: 8px;\n      }\n      .qr-text {\n        text-align: center;\n        font-size: 11px;\n        margin-top: 5px;\n        line-height: 1.3;\n      }\n      .section-title {\n        font-size: 12px;\n        text-transform: uppercase;\n        margin-bottom: 8px;\n        margin-top: 15px;\n      }\n      table {\n        width: 100%;\n        border-collapse: collapse;\n        font-size: 10px;\n      }\n      th {\n        border-top: 1px solid #000;\n        border-bottom: 1px solid #000;\n        padding: 6px 2px;\n        font-weight: bold;\n        vertical-align: top;\n      }\n      td {\n        border-bottom: 1px dashed #000;\n        padding: 8px 2px;\n        vertical-align: top;\n      }\n      .total-row {\n        display: flex;\n        justify-content: space-between;\n        align-items: center;\n        margin-top: 10px;\n        font-size: 14px;\n        font-weight: bold;\n      }\n      .force-feed {\n        margin-top: 30px;\n        visibility: hidden;\n      }\n    </style>\n  </head>\n  <body>\n    <div class="row">\n      <div class="label" style="flex: 0 0 33%">\n        Mã đơn hàng /<br />Order No:\n      </div>\n      <div class="value" style="flex: 0 0 67%">{{ORDER_NO}}</div>\n    </div>\n    <div class="row">\n      <div class="label" style="flex: 0 0 33%">\n        Số giao dịch /<br />Transaction No:\n      </div>\n      <div class="value" style="flex: 0 0 67%">{{TRANSACT}}</div>\n    </div>\n    <div class="row">\n      <div class="label">Khách hàng /<br />Customer:</div>\n      <div class="value">{{CUSTOMER_NAME}}</div>\n    </div>\n    <div class="row">\n      <div class="label">Email:</div>\n      <div class="value">{{EMAIL}}</div>\n    </div>\n    <div class="row">\n      <div class="label">Ngày tham quan /<br />Visit Date:</div>\n      <div class="value">{{VISIT_DATE}}</div>\n    </div>\n    <div class="row">\n      <div class="label">Ngày mua /<br />Purchase Date:</div>\n      <div class="value">{{PURCHASE_DATE}}</div>\n    </div>\n\n    <div class="divider"></div>\n\n    <div class="qr-section">\n      <img\n        src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ORDER_NO}}"\n        alt="QR Code"\n      />\n      <div class="qr-text">\n        Xuất trình mã QR này tại quầy dịch vụ<br />\n        <i>Present this QR code at the service counter</i>\n      </div>\n    </div>\n\n    <div class="section-title">CHI TIẾT DỊCH VỤ / SERVICE DETAILS</div>\n    <table>\n      <thead>\n        <tr>\n          <th style="text-align: left; width: 40%">DỊCH VỤ<br />SERVICE</th>\n          <th style="text-align: center; width: 12%">SL<br />QTY</th>\n          <th style="text-align: center; width: 23%">KHUNG GIỜ<br />TIME</th>\n          <th style="text-align: right; width: 25%">THÀNH TIỀN<br />AMOUNT</th>\n        </tr>\n      </thead>\n      <tbody>\n        {{SERVICES_HTML}}\n      </tbody>\n    </table>\n\n    <div class="total-row">\n      <div>Tổng dịch vụ / Total:</div>\n      <div>{{TOTAL_AMOUNT}}</div>\n    </div>\n\n    <div class="force-feed">.</div>\n  </body>\n</html>\n';
function PageMenu() {
  const navigate = useNavigate();
  ...
  const [transactId, setTransactId] = reactExports.useState("");
  const [transactCheckError, setTransactCheckError] = reactExports.useState("");
  const [isTransactChecking, setIsTransactChecking] = reactExports.useState(false);
  const [isSearchOpen, setIsSearchOpen] = reactExports.useState(false);
  const [isHoangVanSearchOpen, setIsHoangVanSearchOpen] = reactExports.useState(false);
  const [isRefreshing2, setIsRefreshing] = reactExports.useState(false);
  const [hvOrderInfo, setHvOrderInfo] = reactExports.useState(null);
  const [hvChecking, setHvChecking] = reactExports.useState(false);
  const [hvCheckError, setHvCheckError] = reactExports.useState("");
  const [hvUsing, setHvUsing] = reactExports.useState(false);
  const [hvLocalStatus, setHvLocalStatus] = reactExports.useState(null);
  const [hvReturning, setHvReturning] = reactExports.useState(false);
  const [isSetupOpen, setIsSetupOpen] = reactExports.useState(false);
  ...
  const fetchData = reactExports.useCallback(async () => {
    try {
      ...
      if (prodRes.success && prodRes.data) {
        setProducts(
          prodRes.data.sort(
            (a, b) => (a.DESCRIPT || "").localeCompare(b.DESCRIPT || "")
          )
        );
      }
  ...
  reactExports.useEffect(() => {
    fetchData();
    const intervalId = setInterval(fetchData, 1e4);
  ...
  reactExports.useEffect(() => {
    const executeAutoConfirm = async () => {
      ...
      try {
        const res = await HoangVanService.getExpiredOrders(1, 1e3);
        ...
        setAlertConfig({
          isOpen: true,
          title: "Error",
          message: `Auto confirm failed: ${err.message}`,
          type: "error"
        });
      } finally {
    ...
    const checkTime = async () => {
      ...
      const isPastTrigger = now.getHours() > 17 || now.getHours() === 17 && now.getMinutes() >= 20;
      if (isPastTrigger) {
    ...
    const intervalId = setInterval(checkTime, 2e4);
    return () => clearInterval(intervalId);
  }, []);
  const handleTransactionClick = (id) => {
    navigate(`/order?id=${id}`);
  };
  const handleSearchTransact = async () => {
    if (transactId) {
      ...
      try {
        ...
        setTransactCheckError(err.message || "System error");
      } finally {
        setIsTransactChecking(false);
      }
    }
  };
  const handleCheckHoangVanOrder = async (finalOrderNo) => {
    ...
    try {
      ...
      if (res.success && res.data) {
        ...
        if (res.data.orderStatus === "DaSuDung") {
          ...
          if (locRes.success && locRes.data?.status !== void 0) {
      ...
      setHvCheckError(err.message || "System error");
    } finally {
      setHvChecking(false);
    }
  };
  const executeUseHoangVanOrder = async () => {
    ...
    try {
      ...
      if (!useRes.success) {
        if (createRes.data?.transact) {
          await window.api.deleteOrder({
            transact: createRes.data?.transact
          });
        }
        setAlertConfig({
          isOpen: true,
      ...
      const servicesHtml = hvOrderInfo.services?.map(
        (s) => `
        <tr>
      ...
      const finalHtml = templateToUse.replace(/{{ORDER_NO}}/g, hvOrderInfo.orderNo || "").replace(/{{TRANSACT}}/g, String(createRes.data?.transact ?? "")).replace(/{{CUSTOMER_NAME}}/g, hvOrderInfo.buyerName || "").replace(/{{EMAIL}}/g, hvOrderInfo.buyerEmail || "").replace(/{{VISIT_DATE}}/g, hvOrderInfo.visitDate || "").replace(
        /{{PURCHASE_DATE}}/g,
        hvOrderInfo.createdAt ? new Date(hvOrderInfo.createdAt).toLocaleString("vi-VN") : ""
      ).replace("{{SERVICES_HTML}}", servicesHtml).replace("{{TOTAL_AMOUNT}}", totalAmount);
      ...
      setAlertConfig({
        ...
        message: printSuccess ? "Order confirmed and bill printed! Transact: " + createRes.data?.transact : "Order confirmed, but failed to print bill! Transact: " + createRes.data?.transact,
  ...
  const handleUseHoangVanOrder = async () => {
    if (!hvOrderInfo) return;
    const services = hvOrderInfo.services || [];
    if (services.length === 0) {
      setAlertConfig({
    ...
    const now = /* @__PURE__ */ new Date();
    const startDateTime = /* @__PURE__ */ new Date(`${visitDateStr}T${startTimeStr}:00`);
    const endDateTime = /* @__PURE__ */ new Date(`${visitDateStr}T${endTimeStr}:00`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.container, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.header, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles$2.title, children: "Dashboard" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$2.subtitle, children: "Bảo tàng chứng tích chiến tranh" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "12px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              style: styles$2.iconBtn,
              onClick: () => {
                setHvOrderInfo(null);
                setHvCheckError("");
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              style: { ...styles$2.iconBtn, position: "relative" },
              onClick: () => navigate("/expired"),
              title: "Expired Orders",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Archive, { size: 20 }),
                expiredCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      position: "absolute",
                    ...
                    children: expiredCount > 99 ? "99+" : expiredCount
                  }
                )
              ]
            }
            ...
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                RefreshCw,
                {
                  size: 20,
                  style: {
                    transform: isRefreshing2 ? "rotate(180deg)" : "none",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.content, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles$2.card, flex: 1, minWidth: 0 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.cardHeader, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles$2.cardTitle, children: "Transactions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$2.badge, children: transactions.length })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.listContainer, children: isLoading && transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.emptyState, children: "Loading..." }) : transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.emptyState, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              FileText,
              {
                size: 48,
          ...
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.txList, children: transactions.map((tx, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: styles$2.txItem,
              onClick: () => handleTransactionClick(tx.TRANSACT.toString()),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.txLeft, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.txId, children: [
                    "Trans#: ",
                    tx.TRANSACT,
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: new Date(tx.TIMEEND).toLocaleTimeString("vi-VN", {
                          hour: "2-digit",
                          minute: "2-digit"
                        })
                      }
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.txTotal, children: [
                    "Final Total:",
                    " ",
                    (tx.FILTERED_TOTAL ?? tx.FINALTOTAL).toLocaleString("en-US"),
                    " ",
                    "đ"
                  ] })
                ] }),
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: tx.POSAudioStatusName
                        }
                      )
                    ]
                  }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...styles$2.middleColumn, minWidth: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.card, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.cardHeader, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { style: styles$2.cardTitle, children: [
              "Slots - ",
              (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB")
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$2.badge, children: slots.length })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.listContainer, children: isLoading && slots.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.emptyState, children: "Loading..." }) : slots.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.emptyState, children: "No slots found" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.txList, children: slots.map((s, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.txItem, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.txLeft, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.txId, children: s.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles$2.txTotal, color: "#64748b" }, children: [
                s.startTime,
                " - ",
                s.endTime
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.txRight, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                  display: "flex",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      style: {
                        fontSize: "18px",
                        fontWeight: 700,
                        color: s.maxMachines - s.bookedMachines > 0 ? "#10b981" : "#ef4444"
                      },
                      children: [
                        s.bookedMachines,
                        "/",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.cardHeader, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles$2.cardTitle, children: "Products" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          style: {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 20, color: "#64748b" })
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "24px 24px", overflowY: "auto", flex: 1 }, children: products.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.emptyState, children: "No products" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.productList, children: products.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.productItem, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles$2.card, marginTop: "24px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$2.cardHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles$2.cardTitle, children: "Booked Today" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "24px 24px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$2.productItem, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "18px", fontWeight: 500 }, children: "Audio Guide Ticket" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                      ...
                      children: slots.reduce((sum, slot) => sum + slot.bookedMachines, 0)
                    }
                  )
                ] }) })
              ] })
    ...
    hvChecking && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          position: "fixed",
...
function PageOrder() {
  ...
  const handleAction = async (action) => {
    ...
    try {
      const details = transaction.POSDETAILS.map((d) => ({
        PRODNUM: d.PRODNUM,
      ...
      const payload = {
        ...
        Status: action === "Out" ? 1 : 2,
        // 1 = Out, 2 = Return
        PhoneNumber: transactId,
        // Fallback if they searched by phone
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.loadingContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TitleBar, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Loading transaction..." })
    ] });
  }
  if (!transaction) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.container, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.header, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { style: styles$1.backBtn, onClick: () => navigate("/menu"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 24 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Back" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.headerInfo, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { style: styles$1.title, children: [
            "Transaction #",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              style: {
                ...styles$1.badge,
                backgroundColor: isNew ? "#eff6ff" : isOut ? "#fef3c7" : "#d1fae5",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.content, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.leftCol, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.card, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$1.cardHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles$1.cardTitle, children: "Customer Info" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.cardBody, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.infoRow, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$1.infoLabel, children: "Time:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$1.infoValue, children: new Date(transaction.TIMEEND).toLocaleString() })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.infoRow, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$1.infoLabel, children: "Cashier:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$1.infoValue, children: transaction.EMPNAME })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.infoRow, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles$1.infoLabel, children: "Total:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles$1.card, marginTop: "24px", flex: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$1.cardHeader, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { style: styles$1.cardTitle, children: [
              "Items (",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles$1.rightCol, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              isNew && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.actionBlock, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Package,
                  {
                    size: 64,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles$1.actionTitle, children: "Handover Not Recorded" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$1.actionDesc, children: "This bill could not be handed over automatically. Confirm below to mark it as OUT and deduct the stock." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    style: { ...styles$1.actionBtn, backgroundColor: "#3b82f6" },
                    onClick: () => handleAction("Out"),
                    disabled: isProcessing,
                    children: isProcessing ? "Processing..." : "Confirm Handover (OUT)"
                  }
                )
              ] }),
              isOut && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.actionBlock, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Clock,
                  {
                    size: 64,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles$1.actionTitle, children: "Waiting for Return" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$1.actionDesc, children: "The customer is currently using the devices. Click below when they return them." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    style: { ...styles$1.actionBtn, backgroundColor: "#f59e0b" },
                    onClick: () => handleAction("Return"),
                    disabled: isProcessing,
                    children: isProcessing ? "Processing..." : "Confirm Return"
                  }
                )
              ] }),
              isReturn && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.actionBlock, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheckBig,
                  {
                    size: 64,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles$1.actionTitle, children: "Completed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$1.actionDesc, children: "This transaction has been successfully completed and devices returned." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    style: {
              ...
              isExpired && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$1.actionBlock, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CircleCheckBig,
                  {
                    size: 64,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles$1.actionTitle, children: "Transaction Expired" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles$1.actionDesc, children: "This ticket has expired and can no longer be processed." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    style: {
...
function PageExpiredOrders() {
  ...
  const fetchExpiredOrders = async (pageNum = 1, isLoadMore = false) => {
    try {
      setLoading(true);
      setError(null);
      const res = await HoangVanService.getExpiredOrders(
        pageNum,
        50
      );
      if (res.success && res.data) {
  ...
  const handleConfirmReturn = async () => {
    ...
    try {
      ...
      for (const svc of services) {
        ...
        if (createRes.data?.transact) {
          createdTransactIds.push(createRes.data.transact);
        }
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.header, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "24px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { style: styles.backBtn, onClick: () => navigate(-1), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 24 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: styles.title, children: "Expired Orders" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.content, onScroll: handleScroll, children: loading && orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.emptyState, children: "Loading data..." }) : error ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.errorState, children: [
      ...
      error
    ] }) : orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.emptyState, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FileText,
        {
          size: 48,
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.txList, children: [
      orders.map((order) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.txLeft, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.txId, children: [
                "Order#: ",
                order.orderNo,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.txTime, children: new Date(order.expiredAt).toLocaleDateString("vi-VN") })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.txTotal, children: [
                order.buyerName,
                " - ",
                order.buyerPhone || order.buyerEmail
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.txRight, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: 700, color: "#dc2626" }, children: "Expired" })
            ] })
          ]
        },
        order.orderNo
      )),
      loading && orders.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
            textAlign: "center",
    ...
    selectedOrder && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.modalOverlay, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.modalContent, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.modalHeader, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 20, color: "#1e3a8a" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { style: styles.cardTitle, children: "Expired Order Details" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.detailCard, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.detailHeader, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Order No." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailValue, children: selectedOrder.orderNo })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "right" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Status" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailSection, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.infoGrid, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Customer Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailValueSmall, children: selectedOrder.buyerName })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Phone / Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailValueSmall, children: selectedOrder.buyerPhone || selectedOrder.buyerEmail })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Visit Date" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailValueSmall, children: selectedOrder.visitDate })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Expired At" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailValueSmall, children: new Date(selectedOrder.expiredAt).toLocaleDateString(
                    "vi-VN"
                  ) })
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.detailSection, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.detailLabel, children: "Services" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: (selectedOrder.services || []).map((svc, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.serviceItemBox, children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            (svc.totalAmount || svc.unitPrice * svc.quantity || 0).toLocaleString("vi-VN"),
                            " ",
                            "đ"
                          ]
                        }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.detailTotal, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      selectedOrder.totalServiceAmount.toLocaleString("vi-VN"),
                      " đ"
                    ]
                  }
                )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                style: {
                  ...
                  // red for confirm return
                },
                onClick: handleConfirmReturn,
                disabled: confirming,
                children: confirming ? "Processing..." : "Confirm Return Expired Order"
              }
            )
          ]
        }
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/login", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLogin, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/menu", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PageMenu, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/order", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PageOrder, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/expired", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PageExpiredOrders, {}) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertModal,
      {
